...
my @contacts = (["Lampro_C","Lampro_S","Sapro_C","Sapro_S"]);
...
#	my $pile3 = runPileup($seq,$dir,'lamprogilliesOutgroup',$out3,$out4,$finaldir);

	#get sophisticated snps from both
	my $vcf1 = sophSNP($seq,$dir,'jointLamprogillies',$out1,$out2,$finaldir);
	}
rmdir($tmpdir);	
