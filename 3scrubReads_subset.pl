...
my $dir = '/media/DataDrive_/sutureGenomics/';
my $tmpdir = $dir . 'tmp/';
...
my $adaptorFile = $dir . 'illuminaAdapters.fa';
#path to trimmomatic executable
my $trimmomatic = '/home/singhal/programs/Trimmomatic-0.22/trimmomatic-0.22.jar';
#path to blat executable
my $blat = 'blat';
#indexed contaminant genome; here this includes ecoli and rRNA
my $contam = $dir . 'genomes/contaminant.fa';
my $readLength = 100;
...
my @lib = qw(SS35 SS40 SS50 SS135 SS136 SS64);
#my @lib = qw(SS35);
foreach my $lib (@lib) {
